...
class QLearner(object):  		  	   		  	  			  		 			     			  	 
    ...
    def query(self, s_prime, r):  		  	   		  	  			  		 			     			  	 
        ...
        for i in range(0,self.dyna):
            ...
            s_dyna, a_dyna, s_prime_dyna, r_dyna = self.T[index]
            self.Q[s_dyna,a_dyna] = ((1-self.alpha)* self.Q[s_dyna,a_dyna] + self.alpha * (r_dyna + self.gamma * self.Q[s_prime_dyna, np.argmax( self.Q[s_prime_dyna] )]))
